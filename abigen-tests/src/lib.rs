...
mod tests {
    ...
    fn it_decode_event_address_uint256_uint256_address_idx_bytes() {
        ...
        // ethc tools encode --abi ./abigen-tests/abi/tests.json event 'EventAddressIdxUint256Uint256AddressIdx' "0xab07a50AD459B41Fe065f7BBAb866D5390e9f705"  "1000000000000000" "2000000000000000000" "0xcd91a50AD459B41Fe065f7BBAb866D5390e945fa"
        let log = pb::eth::v1::Log{
            address: hex!("0000000000000000000000000000000000000000").to_vec(),
            topics: vec![
            ...
            data: hex!("00000000000000000000000000000000000000000000000000038d7ea4c680000000000000000000000000000000000000000000000000001bc16d674ec80000").to_vec(),
            ..Default::default()
        };

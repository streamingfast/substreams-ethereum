...
### Added
- Added bidirectional conversion between `scalar::BigInt` and `pb::eth::v2::BigInt` via the `From` trait
- Added a new `prelude` module for easy access to common types and conversions
...
## [0.10.4](https://github.com/streamingfast/substreams-ethereum/releases/tag/v0.10.4)

* Updated `firehose-ethereum` Protobuf.

## [0.10.3](https://github.com/streamingfast/substreams-ethereum/releases/tag/v0.10.3)

* Added `// @generated` on top of generated ABI files.

## [0.10.2](https://github.com/streamingfast/substreams-ethereum/releases/tag/v0.10.2)

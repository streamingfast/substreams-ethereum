...
- Publish the draft release in https://github.com/streamingfast/substreams-ethereum/releases/tag/v${version} (**Important** Don't forget this step otherwise release will not be published out!)
